...
var _user$project$Ui$userOption = function (user) {
	return A2(
		_elm_lang$html$Html$option,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$value(user.url)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Ui$usersDropdown = function (users) {
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$List$map, _user$project$Ui$userOption, users)));
};
var _user$project$Ui$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Ui$usersDropdown(model.users)
			]));
};
var _user$project$Ui$User = F2(
	function (a, b) {
		return {name: a, url: b};
	});
var _user$project$Ui$userDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Ui$User,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'url', _elm_lang$core$Json_Decode$string));
var _user$project$Ui$Model = F2(
	function (a, b) {
		return {currentUser: a, users: b};
	});
var _user$project$Ui$FetchUsersFail = function (a) {
	return {ctor: 'FetchUsersFail', _0: a};
};
var _user$project$Ui$FetchUsersOk = function (a) {
	return {ctor: 'FetchUsersOk', _0: a};
};
var _user$project$Ui$fetchUsers = A3(
	_elm_lang$core$Task$perform,
	_user$project$Ui$FetchUsersFail,
	_user$project$Ui$FetchUsersOk,
	A2(
		_evancz$elm_http$Http$get,
		_elm_lang$core$Json_Decode$list(_user$project$Ui$userDecoder),
		'/match/users/'));
var _user$project$Ui$init = {
	ctor: '_Tuple2',
	_0: {
		currentUser: 0,
	...
	_1: _user$project$Ui$fetchUsers
};
var _user$project$Ui$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'FetchUsers':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Ui$fetchUsers};
			case 'FetchUsersOk':
				return {
					ctor: '_Tuple2',
...
var _user$project$Ui$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$Ui$init,
			view: _user$project$Ui$view,
			update: _user$project$Ui$update,
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
		})
};
var _user$project$Ui$FetchUsers = {ctor: 'FetchUsers'};
