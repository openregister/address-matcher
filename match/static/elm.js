									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('See all scores'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
	...
	return A2(
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A3(_user$project$View$viewAddressSection, model.animationStyle, model.currentUserId, model.addresses),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'NextCandidate':
				var _p1 = _p0._0._1;
				var command = A3(_user$project$Rest$sendMatch, _p0._0._0, _p1, model.currentUserId);
