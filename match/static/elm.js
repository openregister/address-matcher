							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(
											_user$project$Stats$nbAddresses(stats)),
										' addresses')),
								_1: {ctor: '[]'}
							}),
						_1: {
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(
												_user$project$Stats$nbMatches(stats)),
											' matches')),
									_1: {ctor: '[]'}
								}),
							_1: {
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(
													_user$project$Stats$nbPass(stats)),
												' matches failed')),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								...
								_user$project$Stats$occurrences(stats))),
						_1: {ctor: '[]'}
					}
				}
			}
	...
	function (stats, currentUserId) {
		return A2(
			...
			},
			{
				ctor: '::',
				_0: A2(
					_user$project$View$viewTopUsers,
					_user$project$Stats$users(stats),
					currentUserId),
				_1: {
					ctor: '::',
					_0: _user$project$View$viewAddressStats(stats),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$View$viewRemoteStats = F2(
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$View$viewUsersSection, model.currentUserId, model.users),
			_1: {
				ctor: '::',
				_0: _user$project$View$viewInfoSection(model.dataSetInfo),
				_1: {
					ctor: '::',
					_0: _user$project$View$viewAddressSection(model),
					_1: {ctor: '[]'}
				}
			}
		});
