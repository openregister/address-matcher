...
var _user$project$Address$remoteAddressCount = function (remoteAddresses) {
	var _p1 = remoteAddresses;
	if (_p1.ctor === 'Success') {
		return _elm_lang$core$List$length(_p1._0);
	} else {
		return 0;
	}
};
...
var _user$project$User$userDecoder = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(_elm_lang$core$Json_Decode$map, _user$project$User$User, _user$project$User$userRecordDecoder),
		_1: {ctor: '[]'}
	});
var _user$project$User$usersDecoder = _elm_lang$core$Json_Decode$list(_user$project$User$userDecoder);

var _user$project$Stats$nbAddresses = function (_p0) {
	var _p1 = _p0;
	return _p1._0.nbAddresses;
};
var _user$project$Stats$nbMatches = function (_p2) {
	var _p3 = _p2;
	return _p3._0.nbMatches;
};
var _user$project$Stats$nbPass = function (_p4) {
	var _p5 = _p4;
	return _p5._0.nbPass;
};
var _user$project$Stats$occurrences = function (_p6) {
	var _p7 = _p6;
	return _p7._0.occurrences;
};
var _user$project$Stats$nbPassRatio = function (_p8) {
	var _p9 = _p8;
	return _p9._0.nbPassRatio;
};
var _user$project$Stats$users = function (_p10) {
	var _p11 = _p10;
...
var _user$project$Stats$occurrenceDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Stats$Occurrence,
	A2(_elm_lang$core$Json_Decode$index, 0, _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$index, 1, _elm_lang$core$Json_Decode$int));
var _user$project$Stats$StatsRecord = F6(
	function (a, b, c, d, e, f) {
		return {nbPassRatio: a, nbMatches: b, nbAddresses: c, nbPass: d, users: e, occurrences: f};
	});
var _user$project$Stats$statsRecordDecoder = A7(
	_elm_lang$core$Json_Decode$map6,
	_user$project$Stats$StatsRecord,
	A2(_elm_lang$core$Json_Decode$field, 'nb_pass_ratio', _elm_lang$core$Json_Decode$float),
	...
	A2(
		...
		'occurrences',
		_elm_lang$core$Json_Decode$list(_user$project$Stats$occurrenceDecoder)));
var _user$project$Stats$Stats = function (a) {
	return {ctor: 'Stats', _0: a};
};
var _user$project$Stats$statsDecoder = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(_elm_lang$core$Json_Decode$map, _user$project$Stats$Stats, _user$project$Stats$statsRecordDecoder),
		_1: {ctor: '[]'}
	});
...
var _user$project$State$SendMatchReturn = function (a) {
	return {ctor: 'SendMatchReturn', _0: a};
};
...
var _user$project$State$FetchAddressesReturn = function (a) {
...
var _user$project$State$FetchUsersReturn = function (a) {
	return {ctor: 'FetchUsersReturn', _0: a};
};
var _user$project$State$FetchUsers = {ctor: 'FetchUsers'};
var _user$project$State$UrlChange = function (a) {
...
var _user$project$View$viewFinishedSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$View$generator('viewFinishedSection'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$View$viewInfoSection = function (model) {
	return A2(
...
var _user$project$View$viewCard = F2(
	function (model, address) {
		return A2(
			_elm_lang$html$Html$div,
			A2(
				_elm_lang$core$Basics_ops['++'],
				_mdgriffith$elm_style_animation$Animation$render(model.animationStyle),
				{
					ctor: '::',
					_0: _user$project$View$generator('viewCard'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
				...
				}),
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('grid-row'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$View$viewMatcher = F3(
	function (model, numberRemaining, address) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$View$generator('viewMatcher'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$View$viewCard, model, address),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$View$viewMatcherSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$View$generator('viewMatcherSection'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewUsersSection(model),
			_1: {
				ctor: '::',
				_0: _user$project$View$viewInfoSection(model),
				_1: {
					ctor: '::',
					_0: _user$project$View$viewMatcherSection(model),
					_1: {
						ctor: '::',
...
var _user$project$Rest$candidateAddressesDecoder = _elm_lang$core$Json_Decode$list(
	A6(
		...
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'parent-address-name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'street-name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'street-town', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'uprn', _elm_lang$core$Json_Decode$string)));
var _user$project$Rest$testDecoder = _elm_lang$core$Json_Decode$list(
	A4(
		...
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int)));
var _user$project$Rest$jsonGetRequest = F2(
	function (url, decoder) {
		return _elm_lang$http$Http$request(
			{
				method: 'GET',
...
var _user$project$Rest$fetchUsers = A2(
...
var _user$project$Rest$fetchDataSetInfo = A2(
	...
	A2(_user$project$Rest$jsonGetRequest, '/match/appinfo/', _user$project$DataSetInfo$dataSetInfoDecoder));
var _user$project$Rest$addCandidates = function (test) {
	var candidatesLookupUrl = A2(
		_elm_lang$core$Basics_ops['++'],
		'/match/brain/?q=',
		_elm_lang$http$Http$encodeUri(test.address));
	return A2(
		_elm_lang$core$Task$map,
		function (candidates) {
...
var _user$project$Main$subscriptions = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: model.animationStyle,
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$userIdFromLocation = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		A2(
			...
			A2(
				...
				_evancz$url_parser$UrlParser$s('userId'),
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'UrlChange':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentUserId: _user$project$Main$userIdFromLocation(_p0._0)
						}),
				...
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								users: _user$project$Types$Success(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								users: _user$project$Types$Failure(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								dataSetInfo: _user$project$Types$Success(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								dataSetInfo: _user$project$Types$Failure(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								addresses: _user$project$Types$Success(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								addresses: _user$project$Types$Failure(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'NextCandidate':
				var _p1 = _p0._0._1;
				var sendMatchCmd = A3(_user$project$Rest$sendMatch, _p0._0._0, _p1, model.currentUserId);
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						addresses: A2(_user$project$Address$removeAddress, _p1, model.addresses)
					});
...
var _user$project$Main$init = function (location) {
	...
	var userId = _user$project$Main$userIdFromLocation(location);
	var initCmd = _elm_lang$core$Native_Utils.eq(userId, 0) ? {
		ctor: '::',
...
var _user$project$Main$locationMessage = function (location) {
	return _user$project$State$UrlChange(location);
};
var _user$project$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Main$locationMessage,
